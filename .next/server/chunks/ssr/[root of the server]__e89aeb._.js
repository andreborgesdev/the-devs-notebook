...
async function Home({ params }) {
    ...
    // Determine folder name and file name from URL segments.
    const folder = params.slug[0];
    // If a child item is specified, use it; otherwise, assume a standalone file.
    const fileName = params.slug.length > 1 ? params.slug[1] : params.slug[0];
    ...
    //   `${fileName}.md`
    // );
    const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", "md", "algorithms", "algorithms.md");
    console.log("TTTTTTTTTT " + filePath);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e89aeb._.js.map
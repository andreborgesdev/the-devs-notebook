...
export const Home = () => {
    return (
        <div>
            <Stack spacing={3}>
                <Text fontSize='2xl' as='b'>A community made with ❤️ from devs to devs</Text>
                ...
                <Link id='gitHubLink' href='https://github.com/andreborgesdev/a-devs-notebook' isExternal>
